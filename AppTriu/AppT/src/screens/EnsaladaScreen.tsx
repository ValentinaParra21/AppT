...
const EnsaladaScreen = () => {
  ...
  const categoriaId = "680887cbb4cabd7316136716"; // ID de la categoría "Ensaladas"
  ...
  useEffect(() => {
    const fetchPlatillos = async () => {
      try {
        ...
        console.error("Error cargando las Ensaladas:", error);
      } finally {
        setLoading(false);
      }
    };
