...
const SopaScreen = () => {
  ...
  const categoriaId = "673436ef4d0de991bee239a9"; // ID de la categoría "Sopas"
  ...
  useEffect(() => {
    const fetchPlatillos = async () => {
      try {
        ...
        console.error("Error cargando las Sopas:", error);
      } finally {
        setLoading(false);
      }
    };
  ...
  return (
    <View style={styles.container}>
      <ScrollView style={styles.scrollContainer}>
        <Text style={styles.titulo}>Sopas</Text>
