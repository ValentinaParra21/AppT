...
const ParaCompartirScreen = () => {
  ...
  const categoriaId = "672ae9e380bcc4b66bcc10a8"; // ID de la categoría "Para compartir"
  ...
  return (
    <View style={styles.container}>
      <ScrollView style={styles.scrollContainer}>
        <Text style={styles.titulo}>Para compartir</Text>
...
export default ParaCompartirScreen;
